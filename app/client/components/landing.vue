<template>
	<div class="landing">
		<h2>
			Bądź bezpieczny w czasie <span>pandemii <span class="bold">COVID-19</span></span>
		</h2>
		<div class="container">
			<div class="links">
...
<style lang="scss" scoped>
	...
	.landing {
		...
		.container {
			...
			img {
				margin-left: 28px;
				width: calc(100vw - 93px - 28px - 24px);
				max-width: 300px;
			}
		}
	}
	...
	@media (min-width: 1024px) {
		.landing {
			...
			.container {
				...
				img {
					margin-left: 56px;
					width: calc(100vw - 116px - 56px - 24px);
					max-width: 500px;
				}
			}
		}
	...
	@media (min-width: 1024px) {
		.landing {
			...
			.container {
				...
				img {
					margin-left: 84px;
					width: calc(100vw - 140px - 56px - 24px);
					max-width: 600px;
				}
			}
		}
