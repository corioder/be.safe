export default {
  async fetchData({ commit, state }) {
    ...
    try {
      ...
      [perday, common, provinces, countryperday, prognosis, categories] = await Promise.all([perdayPromise, commonPromise, provincesPromise, countryperdayPromise, prognosisPromise, categoriesPromise]);
